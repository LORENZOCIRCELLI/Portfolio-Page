...
export default function HeroSection() {
  return (
    ...
    >
      ...
      <div className="absolute top-6 left-1/2 transform -translate-x-1/2 flex gap-3 z-20">
        <a
          href="https://github.com/LORENZOCIRCELLI"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/lorenzocalabresecircelli/"
          target="_blank"
          rel="noopener noreferrer"
          className="p-2 bg-white/5 rounded-full hover:bg-white/10 transition-colors"
        >
        ...
        <a
          href="https://leetcode.com/u/Lorenzo_Circelli/"
          target="_blank"
          rel="noopener noreferrer"
          className="p-2 bg-white/5 rounded-full hover:bg-white/10 transition-colors"
        >
        ...
        <a
          href="https://codeforces.com/profile/Lorenzo.Summerly"
          target="_blank"
          rel="noopener noreferrer"
          className="p-2 bg-white/5 rounded-full hover:bg-white/10 transition-colors"
        >
