...
export const metadata: Metadata = {
	title: 'Lorenzo Circelli - Portfolio',
	description:
	...
	authors: [{ name: 'Lorenzo Circelli' }],
	creator: 'Lorenzo Circelli',
	openGraph: {
		title: 'Lorenzo Circelli - Software Developer Portfolio',
		...
		url: 'https://www.lorenzocircelli.com',
		siteName: 'Lorenzo Circelli - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Lorenzo Circelli - Modern Minimal Portfolio',
			},
		],
		locale: 'pt_BR',
		type: 'website',
	...
	twitter: {
		...
		title: 'Lorenzo Circelli - Software Developer',
		description: 'Passionate software developer creating clean, minimal, and effective digital solutions. Explore my work and development philosophy.',
